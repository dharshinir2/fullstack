...
public class PaymentController {
    ...
    public ResponseEntity<BasicResponse<PaymentResponse>> createPayment(@RequestBody PaymentReq paymentRequest) {
...
public ResponseEntity<BasicResponse<PaymentResponse>> updateBooking(@PathVariable Long PaymentId, @RequestBody PaymentReq payRequest) {
    BasicResponse<PaymentResponse> response = new BasicResponse<>();
    try {
