...
const Payment=()=>{
  ...
  <div className="card__container1">
    <div className="card1">
      <div className="row paypal1">
        <div className="left1">
          <input id="pp1" type="radio" name="payment" />
      ...
      <div className="row cardholder1">
        <div className="info1">
          <label htmlFor="cardholdername1">Name</label>
          <input
