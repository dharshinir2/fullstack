...
public class BookingController {
    ...
    public ResponseEntity<BasicResponse<BookingResponse>> createBooking(@RequestBody BookingReq bookingRequest) {
        BasicResponse<BookingResponse> response = new BasicResponse<>();
        try {
...
public ResponseEntity<BasicResponse<BookingResponse>> updateBooking(@PathVariable String bookingId, @RequestBody BookingReq bookingRequest) {
    BasicResponse<BookingResponse> response = new BasicResponse<>();
    try {
